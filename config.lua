...
Config.PIDToggleKey = Keys["PAGEUP"]        -- The keybind to toggle player ID.
...
Config.parkedOnly = true        -- Lock only parked vehicles if true
...
Config.DiscordRPC = {
    ...
    ["MaxPlayers"] = 128,          -- Maximum number of players
    ["Buttons"] = {               -- Optional buttons with links
        {text = 'DISCORD', value = 'https://discord.gg/PmfctTx6rH'},
